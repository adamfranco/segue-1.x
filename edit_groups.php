...
//	print $del;
	if ($del=='group') {
		...
		log_entry("classgroups","$auser removed group ".db_get_value("classgroups","name","id=$group"),db_get_value("classgroups","name","id=$group"));
	}
	if ($del=='class') {
		...
		log_entry("classgroups","$auser removed $class from group ".db_get_value("classgroups","name","id=$group"),db_get_value("classgroups","name","id=$group"));
	}
//	print $query;
	db_query($query);
