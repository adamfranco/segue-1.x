<? $title = "Themes"; ?>
<p>Themes are a way of letting you make your site look the way you want it to. By choosing a theme, you can change the entire look and feel of your site. To try themes out, choose a theme from the list and click the thumbnail to preview selected theme.
...
<p>In order to properly edit themes you must configure you Pop up Blocker to allow pop up windows from this site.
You can do this as follows:<br />
<ul>
	<li>Mozilla: 1. Chose Tools > Popup Manager 2. Chose to Allow Popups from this site.</li>
	<li>Safari: Deselect Safari > Block Pop-up Windows (Note: Safari does not support a WYSIWYG HTML Editor)</li>
