...
<a href='#' onClick="window.open('topics/headerfooter', 'headerfooter',config='height=650,width=675')"' ><img src=topics/headerfooter_thumb.jpg align=right border=0></a>
 ...
 <p>A custom footer can be an image or text. It will appear at the bottom of all pages in your site. Some themes look better with footers than others.
 
 <p>Click the thumbnail for a larger view.