...
if ($settings[type] == "page") {
	...
	$leftlinks .= "</td><td>";
	if ($settings[step] != 3) $leftlinks .= "<a href=$PHP_SELF?$sid&step=3&link=1 onClick=\"submitForm()\">";
...
if ($settings[type] == "page") {
	...
	$leftlinks .= "</td><td>";
	if ($settings[step] != 4) $leftlinks .= "<a href=$PHP_SELF?$sid&action=edit_page&step=4&link=1 onClick=\"submitForm()\">";
...
// Below here is old code. To be removed when the new stuff above is working.
//--------------------------------------------------------------------------------------------------------
/* 
$add = $edit = 0;
if (!$step) $step = 1;
