...
if ($thisSite->hasPermission("edit")) $text .= "</tr><tr><td><form action='index.php?$sid&action=edit_site&edit_site=$site&comingFrom=viewsite' method=post><input type=submit value='Edit Site Settings'></form></td>";
...
$text .= "</tr><tr>";
$text .= "<td><form action='index.php?$sid&action=site&site=sample' target='_blank' method=post><input type=submit value='View Sample Site'></form></td>";
