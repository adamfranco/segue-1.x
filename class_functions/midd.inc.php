 ...
 * my $BASEDNÊÊÊÊÊ = "OU=Fall03,OU=Classes,OU=Groups,DC=Middlebury,DC=edu"; 
 * my $userÊÊÊÊÊÊÊ = "cn=White\\, Betty,cn=users,dc=middlebury,dc=edu"; 
 * my $passÊÊÊÊÊÊÊ = "*********"; 
 * my $filterÊÊÊÊÊ = "(cn=*ac210a-f03*)"; 
 * my @fieldsÊÊÊÊÊ = ("member"); 
 ******************************************************************************/
